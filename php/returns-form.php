...
if(isset($_POST['name'])){
    ...
    $result = mysqli_query($link, "SELECT max(id) FROM `returns`");
    ...
    $query = "INSERT INTO `returns` (id,`name`, `email`, `orderid`, `message`, `time`, `from_ip`, `from_browser`) VALUES ($id, '$name', '$email', '$orderid', '$message', '$date_now','$from_ip', '$from_browser')";
    ...
    <body>
                                ...
                                <table width="600" align="center" class="margin-pad" border="0" cellpadding="0"
                                    ...
                                    <tr>
                                        <td class="res-center font-poppins-regular"
                                            ...
                                            Thank you <span style="font-weight: bold;">'.$name.'</span> for the submitting the problem for your Order ID <span style="font-weight: bold;">#'.$orderid.'</span><br>you have submitted the following Problems<br><br>
        ...
        $mail->Subject = "Returns | TheTopController";
        $mail->Body    = $body;
