...
if(isset($_POST['name'])){
    ...
    $result = mysqli_query($link, "SELECT max(id) FROM `feedback`");
    ...
    $query = "INSERT INTO `feedback` (id,`name`, `email`, `phone`, `message`, `time`, `from_ip`, `from_browser`) VALUES ($id, '$name', '$email', '$phone', '$message', '$date_now','$from_ip', '$from_browser')";
    ...
    <body>
                                ...
                                <table width="600" align="center" class="margin-pad" border="0" cellpadding="0"
                                    ...
                                    <tr>
                                        <td class="res-center font-poppins-regular"
                                            ...
                                            Thank you <span style="font-weight: bold;">'.$name.'</span> for the Feedback<br>
                                            You have submitted the following message<br><br>
        ...
        $mail->Subject = "Thankyou for your Valuable Feedback | TheTopController";
        $mail->Body    = $body;
        $mail->AltBody = "This email contains feedback";
